...
public class popupsantri1 extends javax.swing.JFrame {
private final Connection conn;
private DefaultTableModel tabmode;
public Nilai santri = null;
 ...
 tabmode = new DefaultTableModel(null, Baris);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popupsantri1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popupsantri1().setVisible(true);
            }
        });
    }
